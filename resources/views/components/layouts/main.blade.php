                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div style="font-weight: bold; color: #333; margin: 10px;">
                            ...
                            <a href="{{ route('posts.create') }}" class="btn btn-primary mr-1 d-none d-lg-block">Create a Post</a>
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="btn btn-dark mr-1 d-none d-lg-block">Log out</button>
                            </form>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-primary mr-1 d-none d-lg-block">Log in</a>
                        @endauth
                    </div>
                </nav>
            </div>
